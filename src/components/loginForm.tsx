...
export default function LoginForm({ onSubmit, loading, error, isRegister }: LoginFormProps) {
        ...
        <Card className="border-0 shadow-2xl bg-card/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 pr-12 border-border/50 focus:border-primary/50 transition-colors"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="h-12 border-border/50 hover:bg-accent/50 transition-colors bg-transparent"
              >
